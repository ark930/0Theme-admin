...
<div class="content page-edit-theme">
    ...
    <div>
        <div class="form-title">Basic</div>
        <div class="form-group">
            <label>Theme Name</label>
            <input type="text" name="themeName" readonly value="{{ Session::has('config') ? Session::get('config')['name'] : ''}}">
        </div>
        <div class="form-group">
            <label>Version</label>
            <input type="text" name="version" placeholder="1.0" readonly value="{{ Session::has('config') ? Session::get('config')['version'] : ''}}">
        </div>
        <div class="form-group">
            <label>Requirements</label>
            <textarea name="requirements" readonly>{{ Session::has('config') ? Session::get('config')['requirements'] : ''}}</textarea>
        </div>
        <div class="form-group">
            <label>Category</label>
            <ul class="tags">
                <li>Portfolio</li><li>Portfolio</li><li>Portfolio</li><li>Portfolio</li>
            </ul>
        </div>
        <div class="form-group">
            <label>Type</label>
            <ul class="tags">
                <li>Designer</li><li>Photographer</li>
            </ul>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="url" name="document" value="{{ Session::has('config') ? Session::get('config')['document_url'] : ''}}" readonly/>
        </div>
        <div class="form-group">
            <label>Free Download(url)</label>
            <input type="url" name="freeUrl" value="{{ Session::has('config') ? Session::get('config')['free_url'] : ''}}" readonly/>
        </div>
        <div class="form-group">
